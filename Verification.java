...
public class Verification {
	...
	 */	
		...
		try{
			...
			headingClickable(webDriver,headingstr);
			BasicOperation.waitFor(6000);
			...
			headingClickable(webDriver,ErrDescr);
			BasicOperation.waitFor(6000);
		} catch (Exception e1) {
			System.out.println("Exception occurred -- " + e1.getMessage());
		...
		public Boolean verifyElement(RemoteWebDriver webDriver,
			...
			} catch (Exception e1)
			{
				...
				reporter.writeStepResult(("Verify Element ....").toUpperCase(),
						"Verifying Element", "Expected: "
								+ "Element", "Fail",
						"Verifying Element", true, webDriver);
				return exists;
...
*/
		...
		public void verifyElementTextPresent(RemoteWebDriver webDriver,
				String strElement, String strExpectedText,String message) {
			...
			try {
					...
					strActualText = displayelement.getAttribute("value");
					if (strActualText == null) {
						strActualText = displayelement.getText();
					}
	...
	public void verifyElementTextPresent(RemoteWebDriver webDriver,
		...
		public void verifyDefaultTextPresent(RemoteWebDriver webDriver,
				String strElement, String strExpectedText) {
				String strActualText = null;
			...
			try {
					//verifyElementPresent(webDriver, strElement, strElementProperty);
					strActualText = displayelement.getAttribute("defaultTxt");
...
/*	// Verifying whether element attribute value is present on the page
	...
	// Verifying number of elemnts on the page
		...
		public void verifyListValue(RemoteWebDriver webDriver, String strElement, String strExpectedValue) {
...
/*	public void verifyListValue(RemoteWebDriver webDriver, String strElement,
		...
		public void verifyListValues(RemoteWebDriver webDriver, String strElement, String strExpectedValues) {
			WebElement listbox = null;
	...
	/*public void verifyListValues(RemoteWebDriver webDriver, String strElement,
		...
		public void verifySelectedListValue(RemoteWebDriver webDriver,
				String strElement, String strExpectedSelectedValue) {
			WebElement listbox = null;
	...
	/*public void verifySelectedListValue(RemoteWebDriver webDriver,
		...
		public void verifyCheckboxStatus(RemoteWebDriver webDriver,
				String strElement, String strExpectedStatus) {
			...
			try {
					...
					//verifyElementPresent(webDriver, strElement);
					strActualStatus = displayelement.getAttribute("checked");
...
/*	public void verifyCheckboxStatus(RemoteWebDriver webDriver,
	...
	public void headingClickable(RemoteWebDriver webDriver,
		...
		try{
			...
			strhyperlink  = displayelement.getAttribute("href");									
...
*/
	...
	public  void imageClickable(RemoteWebDriver webDriver,
			String strElement, String strElementhyperlink,
		...
		try{
			...
			String strsrc = null;
						...
						strsrc = displayelement.getAttribute("src");	
...
*/
	...
	public  void clickable(RemoteWebDriver webDriver,
			String strElement, String homestrElement,String PageTitle) throws Exception	{
			Boolean sFlag = true;
		...
		try{
			...
			String strtitle = null;
					...
					strtitle = displayelement.getAttribute("title");	
...
// Verifying whether image is broken on the page
	public void verifyImageBroken(RemoteWebDriver webDriver,
		...
		public void verifyElementNotClickable(RemoteWebDriver webDriver, String strElement, String message) {
...
/*				public void verifyElementNotClickable(RemoteWebDriver webDriver, String strElement, String strElementProperty,String message) {
		...
		public void verifyElementNotClickable(RemoteWebDriver webDriver, String strElement, String currentpagetitlekey,Map<String, String> DataMap,String elementname) {
			WebElement clickelement=null;
			boolean exists = false;
		...
		public void verifyElementClickable(RemoteWebDriver webDriver, String strElement, String nextpagetitlekey,Map<String, String> DataMap,String elementname) 
		{
			WebElement clickelement=null;
			boolean exists = false;
